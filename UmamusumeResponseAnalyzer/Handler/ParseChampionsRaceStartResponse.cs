...
namespace UmamusumeResponseAnalyzer.Handler
{
    ...
    {
        public static void ParseChampionsRaceStartResponse(Gallop.ChampionsFinalRaceStartResponse @event)
        {
            var data = @event.data;
            ...
            File.WriteAllLines(@$"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "UmamusumeResponseAnalyzer", "races")}/{DateTime.Now:yy-MM-dd HH-mm-ss-fff} Champions.txt", lines);
        }
    }
}
